...
const translations = {
  en: {
    ...
    'exp.job3.desc': 'Development of modules for a proprietary enterprise ERP (Horión Enterprise). Built a full email outbox module: sent email history, attachment download from database, and resend with new file uploads. Working with a multi-tenant PHP architecture, custom routing patterns, binary output buffering, and vanilla JS with MooTools.',
  ...
  es: {
    ...
    'exp.job3.desc': 'Desarrollo de módulos para un ERP empresarial propietario (Horión Enterprise). Implementación de un módulo completo de buzón de salida: historial de correos enviados, descarga de adjuntos desde base de datos y reenvío con nuevos ficheros. Arquitectura PHP multi-tenant, patrón de routing propio, gestión de output buffering binario y JS vanilla con MooTools.',
  ...
  eu: {
    ...
    'exp.job3.desc': 'Modulu garapena enpresa ERP propietario batentzat (Horión Enterprise). Irteera postontzi modulu osoa inplementatuta: bidalitako mezu elektronikoen historia, eranskinak datu-basetik deskargatu eta fitxategi berriekin birbidali. PHP multi-tenant arkitektura, routing eredu propioa, output buffering bitar kudeaketa eta JS vanilla MooTools-ekin.',

...
const translations = {
  en: {
    ...
    'exp.job5.title': 'Java Developer (Freelance)',
    'exp.job5.company': 'Ayuntamiento de Bermeo',
    'exp.job5.date': 'May 2026 - Jun 2026',
    'exp.job5.desc': 'Built a lost-and-found management system in a 15-day sprint: a Swing/JavaFX desktop app for front-desk staff, plus a public web interface for citizens to search and claim items. SQL database on the server with a local backup database and automated backups, so daily operations keep running even if the server goes down. Covered full design and end-to-end delivery, from data model to UI.',
  ...
  es: {
    ...
    'exp.job5.title': 'Desarrollador Java (Freelance)',
    'exp.job5.company': 'Ayuntamiento de Bermeo',
    'exp.job5.date': 'May 2026 - Jun 2026',
    'exp.job5.desc': 'Sistema de gestión de objetos perdidos desarrollado en un sprint de 15 días: aplicación de escritorio en Swing/JavaFX para el personal de atención al público, más una interfaz web para que la ciudadanía consulte y reclame objetos. Base de datos SQL en el servidor con una base de datos local de respaldo y copias de seguridad automáticas, para que la gestión diaria siga funcionando aunque el servidor falle. Diseño y desarrollo completo de principio a fin, desde el modelo de datos hasta la interfaz.',
  ...
  eu: {
    ...
    'exp.job5.title': 'Java Garatzaile (Freelance)',
    'exp.job5.company': 'Bermeoko Udala',
    'exp.job5.date': '2026ko mai. - 2026ko eka.',
    'exp.job5.desc': 'Galdutako objektuak kudeatzeko sistema, 15 eguneko sprint batean garatua: Swing/JavaFX mahaigaineko aplikazioa harrera-langileentzat, eta web interfaze bat herritarrek objektuak bilatu eta erreklamatzeko. SQL datu-basea zerbitzarian, tokiko babeskopia-datubase eta segurtasun-kopia automatikoekin, zerbitzariak huts egin arren eguneroko kudeaketak funtzionatzen jarraitu dezan. Diseinu eta garapen osoa, hasieratik amaierara.',
